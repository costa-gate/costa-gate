...
const modules = [
  {
    title: 'Nova Entrada',
    description: 'Registre novas cargas e entregas.',
    icon: '➕',
    href: '/nova-entrada',
  },
  {
    title: 'Veículos na Unidade',
    description: 'Acompanhe os veículos ativos.',
    icon: '🚚',
    href: '/veiculos-na-unidade',
  },
  {
    title: 'Controle de Contêineres',
    description: 'Controle de estoque, desmontagem, montagem e movimentação.',
    icon: '📦',
    href: '/controle-containers',
  },
  {
    title: 'Consulta',
    description: 'Busque por movimentações e histórico.',
    icon: '🔎',
    href: '/consulta',
  },
  {
    title: 'Painel Operacional',
    description: 'Visualize indicadores operacionais em tempo real.',
    icon: '📊',
    href: '/painel-operacional',
  },
  {
    title: 'Dashboard Gerencial',
    description: 'Indicadores executivos e performance da operação.',
    icon: '📈',
  ...
  {
    title: 'Configurações',
    description: 'Ajuste opções do sistema.',
    icon: '⚙️',
    href: '/configuracoes',
  },
];
            ...
            <div className="flex flex-col gap-4 rounded-[24px] border border-emerald-500/20 bg-slate-950/60 p-6 md:flex-row md:items-center md:justify-between">
              ...
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold text-slate-50">
                  Bem-vindo ao Costa Gate
                </h2>

                <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-400">
                  Controle logístico integrado para terminais, com visão rápida das entradas,
                  veículos, contêineres e ações operacionais.
                </p>
              </div>
